...
public class BlockRegistry {
    ...
    public static final BlockEntry CHESTNUT_LEAVES = new BlockEntry("chestnut_leaves", new Block(FabricBlockSettings.copy(Blocks.OAK_LEAVES).allowsSpawning(BlockRegistry::never).solidBlock(BlockRegistry::never).suffocates(BlockRegistry::never).blockVision(BlockRegistry::never)), ItemGroup.DECORATIONS);
